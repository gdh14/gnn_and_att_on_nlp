...
from model.trainer import GCNTrainer, RNNTrainer
from utils import torch_utils, scorer, constant, helper
from utils.vocab import Vocab

parser = argparse.ArgumentParser()
parser.add_argument('--model', type=str, required=True, help='The category of the model(rnn/gcn)')
...
if not opt['load']:
    if opt['model'] == 'gcn':
        ...
        trainer = RNNTrainer(opt, emb_matrix=emb_matrix)
